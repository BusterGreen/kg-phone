...
$(document).on('click', '.phone-app-footer-button', function(e){
    ...
    if (PressedFooterTab !== CurrentFooterTab) {
        ...
        if (PressedFooterTab == "recent") {
            $.post('https://kg-phone/ClearRecentAlerts');
...
KG.Phone.Functions.SetupRecentCalls = function(recentcalls) {
...
$(document).on('click', '.phone-recent-call', function(e){
    ...
    $.post('https://kg-phone/CallContact', JSON.stringify({
        ContactData: cData,
        Anonymous: KG.Phone.Data.AnonymousCall,
    }), function(status){
        if (cData.number !== KG.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (KG.Phone.Data.AnonymousCall) {
                            KG.Phone.Notifications.Add("fas fa-phone", "Phone", "You started a anonymous call!");
                        }
                        $(".phone-call-outgoing").css({"display":"block"});
                        $(".phone-call-incoming").css({"display":"none"});
                        $(".phone-call-ongoing").css({"display":"none"});
                        $(".phone-call-outgoing-caller").html(cData.name);
                        KG.Phone.Functions.HeaderTextColor("white", 400);
                        KG.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
                        setTimeout(function(){
                            $(".phone-app").css({"display":"none"});
                            KG.Phone.Animations.TopSlideDown('.phone-application-container', 400, 0);
                            KG.Phone.Functions.ToggleApp("phone-call", "block");
                        }, 450);

                        CallData.name = cData.name;
                        CallData.number = cData.number;

                        KG.Phone.Data.currentApplication = "phone-call";
                    } else {
                        KG.Phone.Notifications.Add("fas fa-phone", "Phone", "You're already in a call!");
                    }
                } else {
                    KG.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is busy!");
                }
            } else {
                KG.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not available!");
            }
        } else {
            KG.Phone.Notifications.Add("fas fa-phone", "Phone", "You can't call yourself!");
        }
    });
});
...
KG.Phone.Functions.LoadContacts = function(myContacts) {
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== KG.Phone.Data.PlayerData.charinfo.phone) {
        ...
        setTimeout(function(){
            ...
            KG.Phone.Functions.ToggleApp("phone", "none");
            KG.Phone.Functions.ToggleApp("whatsapp", "block");
            KG.Phone.Data.currentApplication = "whatsapp";

            $.post('https://kg-phone/GetWhatsappChat', JSON.stringify({phone: ContactData.number}), function(chat){
                KG.Phone.Functions.SetupChatMessages(chat, {
        ...
        KG.Phone.Notifications.Add("fa fa-phone-alt", "Phone", "You can't whatsapp yourself..", "default", 3500);
    }
});
...
$(document).on('click', '#edit-contact', function(e){
    ...
    KG.Phone.Animations.TopSlideDown(".phone-edit-contact", 200, 0);
});
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://kg-phone/EditContact', JSON.stringify({
            ...
            KG.Phone.Functions.LoadContacts(PhoneContacts);
        });
        KG.Phone.Animations.TopSlideUp(".phone-edit-contact", 250, -100);
        setTimeout(function(){
            $(".phone-edit-contact-number").val("");
            $(".phone-edit-contact-name").val("");
        }, 250)
    } else {
        KG.Phone.Notifications.Add("fas fa-exclamation-circle", "Edit Contact", "Fill out all fields!");
    }
});
...
$(document).on('click', '#edit-contact-delete', function(e){
    ...
    $.post('https://kg-phone/DeleteContact', JSON.stringify({
        CurrentContactName: ContactName,
        CurrentContactNumber: ContactNumber,
        CurrentContactIban: ContactIban,
    }), function(PhoneContacts){
...
$(document).on('click', '#phone-plus-icon', function(e){
    ...
    KG.Phone.Animations.TopSlideDown(".phone-add-contact", 200, 0);
});
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://kg-phone/AddNewContact', JSON.stringify({
        ...
        KG.Phone.Animations.TopSlideUp(".phone-add-contact", 250, -100);
        setTimeout(function(){
        ...
        if (SelectedSuggestion !== null) {
            $.post('https://kg-phone/RemoveSuggestion', JSON.stringify({
        ...
        KG.Phone.Notifications.Add("fas fa-exclamation-circle", "Add Contact", "Fill out all fields!");
    }
});
        ...
        if (cData.number !== KG.Phone.Data.PlayerData.charinfo.phone) {
            if (status.IsOnline) {
                if (status.CanCall) {
                    ...
                    KG.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is in a call!");
                }
            } else {
                KG.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is not available!");
            }
        } else {
            KG.Phone.Notifications.Add("fas fa-phone", "Phone", "You can't call your own number!");
        }
    });
}

CancelOutgoingCall = function() {
    if (KG.Phone.Data.currentApplication == "phone-call") {
        KG.Phone.Animations.TopSlideUp('.phone-application-container', 400, -160);
    ...
    if (!Canceled) {
        if (!KG.Phone.Data.CallActive) {
            ...
            setTimeout(function(){
                ...
                $(".phone-app").css({"display":"none"});
                KG.Phone.Functions.HeaderTextColor("white", 400);
                $("."+KG.Phone.Data.currentApplication+"-app").css({"display":"none"});
...
KG.Phone.Functions.SetupCurrentCall = function(cData) {
    if (cData.InCall) {
        CallData = cData;
...
$(document).on('click', '.phone-currentcall-container', function(e){
    ...
    KG.Phone.Functions.HeaderTextColor("white", 500);
    KG.Phone.Animations.TopSlideDown('.phone-application-container', 500, 0);
    KG.Phone.Animations.TopSlideDown('.phone-call-app', 500, 0);
    KG.Phone.Functions.ToggleApp("phone-call", "block");
...
$(document).on('click', '#incoming-answer', function(e){
    ...
    $.post('https://kg-phone/AnswerCall');
});

KG.Phone.Functions.AnswerCall = function(CallData) {
    $(".phone-call-incoming").css({"display":"none"});
    $(".phone-call-outgoing").css({"display":"none"});
    $(".phone-call-ongoing").css({"display":"block"});
...
KG.Phone.Functions.SetupSuggestedContacts = function(Suggested) {
