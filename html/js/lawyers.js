            ...
            if (status.IsOnline) {
                if (status.CanCall) {
                    if (!status.InCall) {
                        ...
                        KG.Phone.Notifications.Add("fas fa-phone", "Phone", "You are already connected to a call!");
                    }
                } else {
                    KG.Phone.Notifications.Add("fas fa-phone", "Phone", "This person is already in a call");
                }
            } else {
